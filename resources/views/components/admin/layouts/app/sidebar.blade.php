...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <div id="placeholder" class="w-[250px] h-full hidden lg:block"></div>
    <flux:sidebar fixed stashable id="fixedSidebar"
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group :heading="__('Member')" class="grid">
                <flux:navlist.item icon="users" :href="'/admin/users'" :current="request()->is('admin/users*')"
                    wire:navigate>{{ __('Users') }}</flux:navlist.item>
                <flux:navlist.item icon="user-circle" :href="'/admin/admins'" :current="request()->is('admin/admins*')"
                    wire:navigate>{{ __('Admins') }}</flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>
