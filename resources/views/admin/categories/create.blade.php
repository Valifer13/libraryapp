<x-admin.layouts.app :title="__('Create Category')">
    <h1 class="text-2xl font-medium">Create New Category</h1>
    <div class="max-w-lg mt-5 px-3 py-4 rounded-lg border border-zinc-300 dark:border-zinc-400 bg-zinc-100 dark:bg-zinc-900">
        <form action="/admin/categories" method="post" class="grid gap-5">
            @csrf
            <flux:input placeholder="Category name..." label="Name" name="name" class="max-w-sm" />
            <flux:input placeholder="Red" label="Color" name="color" class="max-w-sm" />
