<div>
    {{-- Wishlist Message --}}
    <script>
        window.addEventListener('wishlist-added', event => {
        ...
        <div class="flex flex-col gap-3">
            ...
            <div class="flex gap-5 mt-2 items-center">
                ...
                <div class="flex gap-3">
                    <flux:button icon="arrow-uturn-left" as="a" href="/books">Back</flux:button>
                    <flux:button variant="primary" icon="shopping-cart" wire:click="borrow">Borrow Now</flux:button>
                    <flux:separator vertical />
                    <flux:button icon="bookmark" wire:click="wishlist"></flux:button>
                </div>
