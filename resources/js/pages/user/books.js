...
//             <flux:badge variant="pill" color="${book.category.color.slice(4, -4)}">${ book.category.name }
//             </flux:badge>
//             <span class="text-xs text-zinc-500">Like: ${ book.liked }</span>
//         </div>
...
//                         });
//                     } else {
//                         results = '<h1 class="text-2xl font-bold text-center">No book found!</h1>';
//                     }
